...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/vlad/Code/WEBank-Laravel/public/storage','fortify.guard',
...
'services.slack.notifications.channel','services.groq.key','session.driver','session.lifetime','session.expire_on_close',
...
'password.reset','password.email','password.store','register',
...
'two-factor.qr-code','two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','sanctum.csrf-cookie','login','user-dashboard','user-transfer','transactions.store',
'ai.operator.chat','cards.transactions','profile.edit','profile.update','profile.destroy',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','storage.local','storage.local.upload',);
