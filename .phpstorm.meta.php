...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/vlad/Code/WEBank-Laravel/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/vlad/Code/WEBank-Laravel/public/storage','inertia.ssr.enabled',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.groq.key','session.driver','session.lifetime',
...
'boost.browser-logs','sanctum.csrf-cookie','api.ai.operator.chat','notification.index','notification.seen','user.dashboard.index','user.dashboard.create',
'user.dashboard.store','user.dashboard.show','user.dashboard.edit','user.dashboard.update','user.dashboard.destroy',
'user.transfer.index','user.transfer.create','user.transfer.store','user.transfer.show','user.transfer.edit',
'user.transfer.update','user.transfer.destroy','user.transactions.export','profile.edit','profile.update',
'verification.notice','verification.verify','login','login.challenge',
'login.challenge.store','password.request','password.email','password.reset','password.store',
